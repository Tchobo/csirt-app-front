                    ...
                    <v-container class="">
                        <v-row>
                            <v-col cols="12" class="flex justify-start flex-col">
                                ...
                                autocomplete="off"
                                    class="font-mono mt-2 pl-3 font-medium leading-6 text-[14px] focus:outline-task-primary border border-x-task-gray h-[40px] w-full rounded-md placeholder-task-input-placeholder"
                                ...
                                <div class="w-100 relative">
                                    <input  v-model="loginData.password" class=" mt-2 pl-3 font-mono font-medium leading-6 text-[14px] focus:outline-task-primary border border-x-task-gray h-[40px] w-full rounded-md placeholder-task-input-placeholder" id="passwordInput" placeholder="***************"
                        ...
                        <v-row class="flex justify-center mt-5">
                            <a href="#" diseable="true" class="text-center underline text-task-bg-blue font-mono font-medium leading-6 text-[14px] cursor-pointer">Forgot password ?</a>
                        </v-row>
